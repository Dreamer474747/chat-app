...
## Changes from the original ui
there is no groups section in the app(it might be added later in the future). there is only contacts section which did not exist in the original ui.

there is no search mechanism in the app for finding the desired contct between the contacts that the user already has(which is going to be added in the future).
